// b-native-computed/signal/src/observe.js
...
// b-native-computed/signal/src/track.js
var trackState = { collector: null };

// b-native-computed/signal/src/signal.js
...
// b-native-computed/signal/src/computed.js
...
// b-native-computed/signal/src/state.js
...
// b-native-computed/signal/index.js
...
// harness/.results/bundles/b-native-computed-plain.js.entry.js
var $a = signal(0);
var $b = signal(1);
var $sum = $S(() => $a() + $b(), $a, $b);
...
globalThis.__size = [$sum(), $filtered(), $s.x(), $fromState(), isObservable($sum)];
var out = [];
out.push($C(() => $a() + $b())());
out.push($CE(() => $s.x() * 2, $s)());
batch(() => {
